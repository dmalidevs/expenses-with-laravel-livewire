<x-app-layout>
    ...
    <section>
        <form method="post" action="{{ route('business.categories.store') }}" class="w-1/3 mx-auto space-y-3 mt-6" enctype="multipart/form-data">
            @csrf
            <div>
                <label for="category_name" class="font-bold">Category Name</label>
                <input type="text" name="category_name" id="category_name" class="w-full rounded"
                    placeholder="add expense type" value="{{ old('category_name') }}">
                            ...
                            <td>
                                <div class="flex items-center justify-center px-6 py-4 space-x-3">
                                    <form method="post" action="{{ route('business.categories.status') }}">
                                        @csrf
                                        <x-button name="statusId" value="{{ $category->id }}"
                                            class="text-{{ $category->status == 1 ? 'green' : 'gray' }}-500 text-white p-2">
                                    ...
                                    <x-button :href="route('business.categories.edit',$category->code)" class="font-medium text-blue-600 dark:text-blue-500">
                                    ...
                                    <form method="post" action="{{ route('business.categories.delete',$category->code) }}">
                                        @csrf
                                        <x-button name="deleteCode" value="{{ $category->code }}"
